...
test.describe("Valid links and clickability", () => {
  ...
  test("Should validate inquiry phone number is clickable", async ({
    page,
  }) => {
    await expect(mainPage.phoneNumber).toHaveAttribute(
      "href",
      "tel:+74956402394",
    );
  ...
  const partners = [
    ...
    {
      name: "Omni360",
      locator: "partnerOmni360",
      url: /https:\/\/navigator.sk.ru\/?/,
    },
    {
      name: "Ingos",
      locator: "partnerIngos",
      url: /https:\/\/www.ingos.ru\/?/,
    },
    {
      name: "Mvideo",
      locator: "partnerMvideo",
      url: /https:\/\/www.mvideoeldorado.ru\/?/,
    },
    {
      name: "LemanaPro",
      locator: "partnerLemanaPro",
  ...
  test("Should validate Company Phone is clickable", async ({ page }) => {
    ...
    await expect(mainPage.companyPhone).toHaveAttribute(
      "href",
      "tel:+74956402394",
    );
  ...
  test("Should validate Company Email is clickable", async ({ page }) => {
    ...
    await expect(mainPage.companyEmail).toHaveAttribute(
      "href",
      "mailto:jump@tages.ru",
    );
  ...
  test("Should validate Media Phone is clickable", async ({ page }) => {
    ...
    await expect(mainPage.mediaPhone).toHaveAttribute(
      "href",
      "tel:+79153646126",
    );
  ...
  test("Should validate Media Email is clickable", async ({ page }) => {
    ...
    await expect(mainPage.mediaEmail).toHaveAttribute(
      "href",
      "mailto:pr@tages.ru",
    );
  ...
  test("Should validate HR Email is clickable", async ({ page }) => {
    ...
    await expect(mainPage.hrEmail).toHaveAttribute(
      "href",
      "mailto:HR@tages.ru",
    );
  ...
  test("Should validate Requisites page link is clickable", async ({
    page,
  }) => {
    ...
    await expect(
      mainPage.page.getByRole("heading", { name: /Реквизиты/ }),
    ).toBeVisible();
    await expect(
      mainPage.page.getByRole("heading", {
        name: "Карточка предприятия ООО “Тагес Джамп”",
      }),
    ).toBeVisible();
  });
  ...
  const socialMedia = [
    ...
    { name: "VK", locator: "vkLink", url: "https://vk.com/tagesru" },
    {
      name: "YouTube",
      locator: "youtubeLink",
      url: /https:\/\/www\.youtube\.com\/channel\/UCBK5-lZpfKeu_yjH30DpvSQ\/?/,
    },
  ];
